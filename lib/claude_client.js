...
- DQ on ICP location (e.g. Russia) is IMMEDIATE once the visitor reveals their location — this is correct, not "premature". The bot is NOT expected to proactively ask about location — it only screens for location when the visitor mentions it
...
- Budget of €5,000 or above is sufficient (m_money = positive) — do NOT penalize the bot for proceeding to booking with €5K+
