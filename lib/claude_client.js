...
6. OUTCOME APPROPRIATENESS (1-5) — Correct routing? Appropriate close message? Was the lead scored correctly given the information available?
7. WOULD I BOOK A CALL? (1-5) — As this persona, would you convert? What was the drop-off moment? (Score 5 if the persona wouldn't book but the bot correctly didn't push)
